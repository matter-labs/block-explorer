...
describe("defaultWithdrawalInitiatedHandler", () => {
  ...
  describe("extract", () => {
    it("extracts transfer with from field populated with lower cased l2Sender", async () => {
    ...
    it("extracts transfer with to field populated with lower cased l1Receiver", async () => {
      const result = await defaultWithdrawalInitiatedHandler.extract(log, blockchainService, blockDetails);
    ...
    describe("when transaction details are specified", () => {
      ...
      it("extracts transfer with timestamp equals to transaction receivedAt", async () => {
        const result = await defaultWithdrawalInitiatedHandler.extract(
          log,
          blockchainService,
          blockDetails,
          transactionDetails
