...
export class AccountController {
  ...
  public async getAccountEtherBalance(
    ...
    const balance = await this.balanceService.getBalance(address, NATIVE_TOKEN_L2_ADDRESS);
    return {
  ...
  public async getAccountsEtherBalances(
    ...
    const balances = await this.balanceService.getBalancesByAddresses(addresses, NATIVE_TOKEN_L2_ADDRESS);
