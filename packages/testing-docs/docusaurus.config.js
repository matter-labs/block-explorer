    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            type: 'docSidebar',
            sidebarId: 'automationTestsSidebar',
            position: 'left',
            label: 'Automated test cases',
          },
          {to: '/blog', label: 'Blog', position: 'left'},
          //{to: '/docs/tutorial-basics/create-a-document', label: 'Automated test cases', position: 'left'},
          {
            href: 'https://github.com/matter-labs/',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Matter Labs. Built with Docusaurus.`,
      },
      prism: {
