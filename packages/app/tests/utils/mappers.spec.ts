    ...
    const contractEvents = [
      {
        ...
        blockHash:
          '0xd2a12062d1ebb1dedad2fd378ba91c90c59a061a1938657e3ab6c508130d0124',
        blockNumber: '0x2e3099',
        l1BatchNumber: '0x92bab',
        transactionHash:
          '0x34c62716d99068c6a7742cc74fe9c0020d7a600a67ea2d8a216ab93182995a90',
      ...
      memory_interactions: [
        {
          ...
          address: 0,
          value:
            '0000000000000002000000000000000200000000000000010000000000010355',
          direction: 'Read',
        },
      ],
      memory_snapshots: [
    ...
    expect(resultHex).toEqual({
      ...
      memory_snapshots: [
        ...step.memory_snapshots.map((e) => ({
          ...e,
          values: [
            ...e.values.map((value) => formatHexDecimals(value, dataFormatHex)),
          ],
        })),
      ],
      registers: [
        ...step.registers.map((value) =>
          formatHexDecimals(value, dataFormatHex),
        ),
      ],
    });
    ...
    expect(resultDecimals).toEqual({
      ...
      memory_snapshots: [
        ...step.memory_snapshots.map((e) => ({
          ...
          values: [
            ...e.values.map((value) =>
              formatHexDecimals(value, dataFormatDecimals),
            ),
          ],
        })),
      ],
