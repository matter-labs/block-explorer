...
describe('Table', () => {
  it('renders properly', () => {
    ...
    expect(container.querySelector('table > thead > tr > th')?.innerHTML).toBe(
      'Table head 1',
    );
    expect(container.querySelector('table > tbody')?.childElementCount).toBe(3);
    expect(container.querySelector('table > tbody')?.innerHTML).toContain(
      'item 1 - 0',
    );
    expect(container.querySelector('table > tbody')?.innerHTML).toContain(
      'item 2 - 1',
    ...
    expect(container.querySelector('.table-footer')?.innerHTML).toBe(
      'Footer slot',
    );
  });
