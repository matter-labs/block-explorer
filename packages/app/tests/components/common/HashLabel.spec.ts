...
describe('HashLabel:', () => {
  it('correctly renders value', async () => {
    ...
    expect(
      getAllByText('0xaBEA9132b05A70803a4E85094fD0e1800777fBEF'),
    ).toBeTruthy();
  });
  ...
  describe('shortenFitText:', () => {
    ...
    it("correctly cuts text if rootWidth and singleCharacterWidth isn't specified", () => {
      ...
      ).toEqual('0x286fa01d8cb...f73d34b1a7a39');
    });
    it('correctly returns text that fully fits', () => {
      ...
      expect(
        ...
        '0x286fa01d8cbcee191d6cf0ada2f1...63b4bf7e7daf58aa4f73d34b1a7a39',
      );
    });
  });
