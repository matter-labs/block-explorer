...
describe("FunctionForm:", () => {
  ...
  it("handles various boolean input formats correctly", async () => {
    const wrapper = mount(FunctionForm, {
      global,
      props: {
        type: "write",
        abiFragment: {
          inputs: [
            ...
            { internalType: "bool", name: "flag3", type: "bool" },
            { internalType: "bool", name: "flag4", type: "bool" },
            { internalType: "bool", name: "flag5", type: "bool" },
            { internalType: "bool", name: "flag6", type: "bool" },
          ],
          name: "testMultipleBools",
          outputs: [],
          stateMutability: "nonpayable",
          type: "function",
        },
    ...
    await fields[0].findComponent(Input).find("input").setValue("true");
    await fields[1].findComponent(Input).find("input").setValue("TRUE");
    await fields[2].findComponent(Input).find("input").setValue("t");

    // Test various false values
    await fields[3].findComponent(Input).find("input").setValue("false");
    await fields[4].findComponent(Input).find("input").setValue("0");
    await fields[5].findComponent(Input).find("input").setValue("F");
