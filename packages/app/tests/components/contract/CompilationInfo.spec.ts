...
describe('CompilationInfo', () => {
  ...
  it('renders component properly', async () => {
    ...
    expect(container.querySelectorAll('.label')[1].textContent).toEqual(
      'Compiler Version',
    );
    expect(container.querySelectorAll('.text')[1].textContent).toEqual(
      '0.8.16',
    );
    expect(container.querySelectorAll('.label')[2].textContent).toEqual(
      'Zksolc Version',
    );
    expect(container.querySelectorAll('.text')[2].textContent).toEqual(
      'v1.1.5',
    );
