...
Feature: Redirection
  ...
  Scenario Outline: Verify redirection for "<Extra button name>" on Footer for internal links
    ...
    Examples:
      ...
      | Docs              | https://docs.zksync.io/zksync-network/zksync-era/custom-tooling         |
  ...
  Scenario: Verify redirection for Documentation link
    ...
    Then New page have "https://docs.zksync.io/zksync-network/zksync-era/custom-tooling" address
