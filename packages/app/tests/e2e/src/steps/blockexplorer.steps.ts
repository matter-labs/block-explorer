...
Given(
  'I fill the search field by {string}',
...
Then(
  'Current page have {string} address',
  async function (this: ICustomWorld, route: string) {
    mainPage = new MainPage(this);
...
Then(
  'Current page includes {string} part address',
  async function (this: ICustomWorld, partRoute: string) {
    mainPage = new MainPage(this);
    helper = new Helper(this);
...
Then(
  'Page with part address {string} includes ID result',
  async function (this: ICustomWorld, partRoute: string) {
    mainPage = new MainPage(this);
    helper = new Helper(this);
...
When(
  'I click on the first {string} link',
  async function (this: ICustomWorld, elementType: string) {
    mainPage = new MainPage(this);
    helper = new Helper(this);
...
When(
  'I click on the first contract address',
...
When(
  'I go to the first Processed transaction link',
  async function (this: ICustomWorld) {
    mainPage = new MainPage(this);
    basePage = new BasePage(this);
    helper = new Helper(this);
...
When(
  'I click by element with partial href {string}',
  async function (this: ICustomWorld, partialHref: string) {
    mainPage = new MainPage(this);
...
When(
  'I click on datatype dropdown of {string} row',
  async function (this: ICustomWorld, rowName: string) {
    transactionPage = new TransactionPage(this);
...
When(
  'I select {string} as dropdown value',
...
Then(
  'Check the element contains text {string}',
  async function (this: ICustomWorld, text: string) {
    mainPage = new MainPage(this);
    element = await mainPage.getElementByPartialText(text);
...
Then(
  'Check the element have the exact text {string}',
  async function (this: ICustomWorld, text: string) {
    mainPage = new MainPage(this);
...
Then(
  'Table contains row with {string}',
  async function (this: ICustomWorld, rowName: string) {
    transactionPage = new TransactionPage(this);
    result = await this.page
      ?.locator(await transactionPage.getRowByText(rowName))
      .first();
...
Then(
  'Table contains cell with {string}',
  async function (this: ICustomWorld, rowName: string) {
    transactionPage = new TransactionPage(this);
    result = await this.page?.locator(
      await transactionPage.getCellByText(rowName),
    );
...
Then(
  ...
  async function (this: ICustomWorld, rowName: string, copying: boolean) {
    transactionPage = new TransactionPage(this);
    result = await this.page?.locator(
      await transactionPage.getValueInRow(rowName, copying),
    );
...
Then(
  'I select {string} tab on {string} page',
  async function (this: ICustomWorld, tabName: string, pageName: string) {
    mainPage = new MainPage(this);
...
Then(
  'I press Verify Smart Contract button',
  async function (this: ICustomWorld) {
    contractPage = new ContractPage(this);
...
Then(
  'Tab title on {string} contains {string}',
  async function (this: ICustomWorld, _route: string, tabTitle: string) {
...
Then(
  'Column with {string} name is visible',
  async function (this: ICustomWorld, columnName: string) {
    basePage = new BasePage(this);
...
Then(
  'Network stats {string} block should be visible',
  async function (this: ICustomWorld, blockName: string) {
    mainPage = new MainPage(this);
...
Then(
  'I click on the copy button for page title',
  async function (this: ICustomWorld) {
    contractPage = new ContractPage(this);
...
Then(
  'I click on the copy button for deployed bytecode',
  async function (this: ICustomWorld) {
    contractPage = new ContractPage(this);
...
Then(
  'I click on the copy button for the first token asset',
  async function (this: ICustomWorld) {
...
Then(
  'Clipboard contains {string} value',
  async function (this: ICustomWorld, text: string) {
    helper = new Helper(this);
...
Then(
  'Clipboard includes {string} value',
  async function (this: ICustomWorld, text: string) {
    helper = new Helper(this);
    result = await helper.getClipboardValue();
...
Then(
  'Verify the badge with {string} status is visible',
