<template>
  <div class="maintenance-container">
    <div class="maintenance">
      ...
      <h1 class="title">
        {{ t('maintenance.title', { network: currentNetwork.l2NetworkName }) }}
      </h1>
      <i18n-t
        class="description"
        scope="global"
        keypath="maintenance.description"
        tag="p"
      >
        <template #network>
        ...
        <template #twitter>
          <a href="https://twitter.com/ZKsyncDevs" target="_blank">{{
            t('maintenance.twitterLink')
          }}</a>
        </template>
        <template #uptime>
          <a href="https://uptime.com/statuspage/era" target="_blank">{{
      ...
      <a
        class="uptime-link"
        href="https://uptime.com/statuspage/era"
        target="_blank"
      >
        {{ t('maintenance.uptimeLink') }}
      </a>
