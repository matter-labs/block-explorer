...
.card {
  ...
  .cost {
    ...
    > span {
      @apply h-6 rounded-md bg-blue px-2.5 text-base font-bold text-white;
    }
  }
  ...
  .popover-panel {
    @apply absolute -top-10 left-1/2  -translate-x-1/2 transform rounded-lg bg-white p-2 px-3 text-sm shadow-lg;
  }
}
</style>
