...
export const PrimaryDisabledLoading = Template.bind({}) as unknown as {
  args: Args;
};
...
export const PrimaryMdContained = Template.bind({}) as unknown as {
  args: Args;
};
...
export const PrimaryLgContained = Template.bind({}) as unknown as {
  args: Args;
};
...
export const SecondaryDisabledLoading = Template.bind({}) as unknown as {
  args: Args;
};
...
export const SecondaryMdContained = Template.bind({}) as unknown as {
  args: Args;
};
...
export const SecondaryMdOutlined = Template.bind({}) as unknown as {
  args: Args;
};
...
export const SecondaryLgContained = Template.bind({}) as unknown as {
  args: Args;
};
...
export const SecondaryLgOutlined = Template.bind({}) as unknown as {
  args: Args;
};
