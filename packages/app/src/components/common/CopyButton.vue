...
.copy-button-container {
  ...
  .copy-button {
    @apply absolute -left-1 -top-1 rounded-md p-1 text-silver-500 transition-colors hover:text-cream focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500;
