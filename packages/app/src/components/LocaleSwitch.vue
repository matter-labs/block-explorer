...
.language-switch {
  ...
  .language-list-wrapper {
    @apply absolute top-full right-0 h-auto w-full lg:w-[60px];
  }
  .language-list {
  ...
  .toggle-button {
    @apply relative flex w-full items-center rounded-md border border-neutral-300 bg-white py-2 px-2 font-sans text-base text-neutral-700 hover:cursor-pointer focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 lg:w-max lg:border-primary-800 lg:bg-primary-800 lg:text-white;
