<template>
  <div class="label-container">
    <div>
      <p class="label">
        {{ t('contractVerification.compilationInfo.contractName') }}
      </p>
      <p class="text">{{ contractName }}</p>
    </div>
    <div>
      <p class="label">
        {{ t('contractVerification.compilationInfo.compilerVersion') }}
      </p>
      <p class="text">
        {{
          verificationRequest?.compilerSolcVersion ||
    ...
    <div>
      ...
      <p class="text">
        {{
          verificationRequest?.compilerZksolcVersion ||
          verificationRequest?.compilerZkvyperVersion
        }}
      </p>
    </div>
    <div>
      <p class="label">
        {{ t('contractVerification.compilationInfo.optimization') }}
      </p>
...
const verificationRequest = computed(
  () => props.contract.verificationInfo?.request,
);
const optimization = computed(() =>
  props.contract.verificationInfo?.request.optimizationUsed ? 'Yes' : 'No',
);
