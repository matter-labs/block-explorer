...
.code-block-container {
  .code-block-header {
    @apply sticky top-0 z-10 mb-1 flex items-center justify-between bg-night-1000 text-silver-500;
    ...
    .code-block-buttons {
      ...
      .expand-button {
        @apply rounded-md p-1.5 text-silver-500 transition-colors hover:text-cream focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500;
