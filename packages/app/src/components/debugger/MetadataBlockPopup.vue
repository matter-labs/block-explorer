...
.metadata-popup-container {
  ...
  .metadata-popup-header-container {
    ...
    .metadata-popup-nav-container {
      ...
      .navigation-button {
        @apply flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-none  border-l border-y-transparent border-y-neutral-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-400 disabled:cursor-not-allowed disabled:opacity-50;
      }
    }
  }
