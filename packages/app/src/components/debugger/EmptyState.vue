...
.upload-file {
  @apply relative flex items-center justify-center  gap-1 whitespace-pre-line rounded-lg border border-dashed border-night-1300 bg-night-800 py-8 text-base text-sm text-night-500 sm:py-12 sm:text-base;
