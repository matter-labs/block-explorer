...
.metadata-block {
  ...
  .meta-info {
    @apply col-span-6 h-max gap-y-2 bg-night-1000 py-1 pl-2 pr-2;
    .badge-flag {
  ...
  .badge-wrap {
    ...
    .memory-badge-index {
      @apply col-[1] h-[20px] min-w-[20px] text-ellipsis rounded bg-night-900 px-[2px] text-center leading-5;
    }
    .memory-badge-hash {
