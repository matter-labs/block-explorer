...
.contract-events-container {
  ...
  table {
    ...
    td {
      ...
      &:before {
        @apply absolute left-4 top-2.5 whitespace-nowrap pr-5 text-left text-xs uppercase text-silver-500 content-[attr(data-heading)] md:content-none;
      }
    }
  }

  .first-col {
    @apply overflow-hidden text-silver-500;
    a {
